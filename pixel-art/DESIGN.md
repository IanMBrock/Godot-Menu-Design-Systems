...
--- Modern Pixel Art ---
- Crisp pixel-perfect rendering, integer scaling, no anti-aliasing
- Contemporary palette feel (not strictly retro/8-bit)
- Modern UX patterns (clear hierarchy, generous spacing) in pixel form
- Subtle dithering or chunky drop shadows acceptable
- Reference vibe: Sea of Stars, Eastward, Chained Echoes
